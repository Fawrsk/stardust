...
def main():
    ...
    delete_file_types("build-vc80/newview/stardust-bin.dir/Release/",
                      pch_types)
    delete_file_types("build-vc80/newview/RelWithDebInfo", build_types)
    delete_file_types("build-vc80/newview/stardust-bin.dir/RelWithDebInfo/",
                      pch_types)
    delete_file_types("build-vc80/newview/Debug", build_types)
    delete_file_types("build-vc80/newview/sstardust-bin.dir/Debug/",
                      pch_types)
