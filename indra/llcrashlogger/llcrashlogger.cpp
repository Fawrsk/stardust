...
void LLCrashLogger::gatherFiles()
{
	...
	else
	{
		...
		mFileMap["SecondLifeLog"] = gDirUtilp->getExpandedFilename(LL_PATH_DUMP,"Stardust.log");
    ...
    {
        mFileMap["SecondLifeLog"] = gDirUtilp->getExpandedFilename(LL_PATH_LOGS,"Stardust.old");
    }
